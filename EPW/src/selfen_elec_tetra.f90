...
#include "f_defs.h"
  ...
  call kpoint_grid ( nsym, time_reversal, s, t_rev, bg, npk, &
                         k1,k2,k3, nqf1,nqf2,nqf3, nks, xk, wk)
  ...
  call tetrahedra ( nsym, s, minus_q, at, bg, npk, k1,k2,k3, &
     nqf1,nqf2,nqf3, nksqf, xk, wk, ntetraf, tetraf )

  !defined tweights (nks, nspin, nbnd, nelec, ntetra, tetra, et, &
  !   ef, wg, is, isk )
  call tweights (nks, nspin, nbnd, nelec, ntetraf, tetraf, et, &
     eff, wgf, is, isk )
